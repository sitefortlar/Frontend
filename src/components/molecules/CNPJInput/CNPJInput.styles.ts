/**
 * CNPJInput Component - Styled Components
...
export const CNPJInputContainer = styled.div`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
...
export const StyledCNPJInput = styled.input<CNPJInputProps>`
  display: flex;
  width: 100%;
  ...
  ${props => props.hasSearchButton && css`
    padding-right: 3rem;
  `}
